...
const Locations = () => {
  return (
    <section className="locations-home">
      <div className="location-content-home">
        <h2>New Locations!</h2>
        <p>
      ...
      <div className="location-cards-home">
        {locations.slice(0, 3).map((loc, index) => (
          <div
            className="location-card-home"
            key={loc.seed}
